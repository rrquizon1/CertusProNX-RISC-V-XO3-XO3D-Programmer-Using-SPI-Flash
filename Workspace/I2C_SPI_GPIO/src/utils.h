...
#ifdef CPU0_INST_NAME
#define CPU_INST_NAME CPU0_INST_NAME
#define CPU_INST_BASE_ADDR CPU0_INST_BASE_ADDR
#else
#ifdef CPU1_INST_NAME
#define CPU_INST_NAME CPU1_INST_NAME
#define CPU_INST_BASE_ADDR CPU1_INST_BASE_ADDR
#endif
#endif

#define TIMER0_INST_BASE_ADDR (CPU_INST_BASE_ADDR + 0x400)
